...
namespace Thinktecture.IdentityModel.Authorization
{
    ...
    public sealed class ClaimPermission : IPermission, ISecurityEncodable, IUnrestrictedPermission
    {
        ...
        public void Demand()
        {
            var claimsAuthorizationManager = FederatedAuthentication.ServiceConfiguration
        ...
        public static bool CheckAccess(string action, string resource, params Claim[] additionalResources)
        {
            ...
            var context = CreateAuthorizationContext((ClaimsPrincipal)Thread.CurrentPrincipal, resourceAction);
